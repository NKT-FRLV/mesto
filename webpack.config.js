...
module.exports = {
      ...
      },
      {
        ...
        use: [
          MiniCssExtractPlugin.loader,
          {
            ...
            options: { importLoaders: 1 }, //если используете @import для css
          },
  ...
  plugins: [
    ...
    new CleanWebpackPlugin(), // использовали плагин отчистки html в дисте.
    new MiniCssExtractPlugin(), // подключение плагина для объединения файлов css @import
  ],
};
